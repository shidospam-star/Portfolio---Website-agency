    ...
    <section className="grid-lines relative overflow-hidden border-b border-border">
      <div className="mx-auto max-w-7xl px-5 pb-14 pt-14 sm:px-8 lg:pb-20 lg:pt-20">
        <div className="grid gap-10 lg:grid-cols-[1fr_17rem] lg:items-end">
          <div><p className="eyebrow animate-fade-in">Independent web studio · Worldwide</p><h1 className="mt-6 max-w-5xl font-display text-5xl font-medium leading-[0.9] sm:text-7xl lg:text-[6.8rem]">Small business.<br /><span className="text-primary">Unmistakable</span> presence.</h1></div>
